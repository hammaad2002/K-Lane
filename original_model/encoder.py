...
class Projector(nn.Module):
    ...
    def __init__(self,
        ...
        self.featuremap_out_channel = featuremap_out_channel
        self.resnet = ResNetWrapper(
            ...
            featuremap_out_channel=self.featuremap_out_channel
        )
    ...
    def __init__(self, 
        ...
        if out_conv:
            ...
            for chan in reversed(self.in_channels):
                ...
                break
            self.out = conv1x1(
                out_channel * self.model.expansion, self.featuremap_out_channel)
